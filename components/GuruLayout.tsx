...
export function GuruLayout({ children }: GuruLayoutProps) {
  ...
  const schoolName = schoolSettings?.nama_sekolah || 'SMK Negeri 1 Surabaya';
          ...
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center">
              {schoolSettings?.logo_url ? (
                <img src={schoolSettings.logo_url} alt="Logo" className="w-6 h-6 object-contain" />
              ) : (
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <div className="bg-blue-50 p-3 rounded-lg">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-blue-700 truncate">{schoolName}</span>
            </div>
            <p className="text-xs text-blue-600 mt-1">Guru Pembimbing v1.0</p>
          </div>
        </div>
      </div>
