  ...
  return (
    <AdminLayout>
      <div className="space-y-6">
        ...
        {/* Logbook Section - Placeholder for future implementation */}
        <Card>
          <CardHeader>
            <div className="flex items-center space-x-2">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Mempelajari sistem database dan melakukan backup data harian</p>
                    <p className="text-sm text-gray-600">Kendala: Tidak ada kendala berarti</p>
                    <div className="flex items-center space-x-2 text-xs text-gray-500">
                      <Clock className="w-3 h-3" />
                      <span>29/7/2024</span>
                    </div>
              ...
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Membuat design mockup untuk website perusahaan</p>
                    <p className="text-sm text-gray-600">Kendala: Software design masih dalam tahap familiar</p>
                    <div className="flex items-center space-x-2 text-xs text-gray-500">
                      <Clock className="w-3 h-3" />
                      <span>29/7/2024</span>
                    </div>
              ...
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Mengikuti training keamanan sistem informasi</p>
                    <p className="text-sm text-gray-600">Kendala: Materi cukup kompleks untuk dipahami</p>
                    <div className="flex items-center space-x-2 text-xs text-gray-500">
                      <Clock className="w-3 h-3" />
                      <span>29/7/2024</span>
                    </div>
